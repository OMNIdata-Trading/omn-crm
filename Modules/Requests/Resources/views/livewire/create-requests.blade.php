          ...
          <div class="row row-cards">
            <div class="col-md-6">
              <div class="mb-3">
                ...
                >
                    <option value="no-company">-- Sem Empresa --</option>
            ...
            <div class="col-sm-6 col-md-6">
              <label for="select-client-company-colaborators" class="form-label">Responsável</label>
                <select type="text" class="form-select" placeholder="Seleccione os responsáveis da solicitação" id="select-client-company-colaborators">
