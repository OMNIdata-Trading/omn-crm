@extends('modules.auth.layout.master')

@section('auth.page.title')
...
<div class="text-center mb-4">
    <a href="." class="navbar-brand navbar-brand-autodark">
      <img src="{{ URL::to('static/logo/logo.svg') }}" height="36" alt="">
    </a>
</div>
        ...
        <div class="mb-2">
          <label class="form-label">
            ...
            <span class="form-label-description">
              <a href="./forgot-password.html">Esqueci-me da senha</a>
            </span>
          </label>
