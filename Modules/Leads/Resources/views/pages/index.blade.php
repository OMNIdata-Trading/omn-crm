                ...
                <table class="table table-vcenter table-mobile-md card-table">
                  ...
                  <tbody>
                    <tr>
                      <td data-label="Name" >
                        <div class="d-flex py-1 align-items-center">
                          ...
                          <div class="flex-fill">
                            <div class="font-weight-medium">Uniel S.A.</div>
                            <div class="text-muted"><a href="#" class="text-reset">unitel.co.ao</a></div>
                          </div>
                        </div>
                      </td>
                      <td data-label="Address" >
                        <div>Rua 543, Avenida C, Luanda, Angola</div>
                        <div class="text-muted"><a href="#" class="text-reset">geral@unitel.co.ao</a></div>
                      </td>
                      <td data-label="Contacts" >
                        <div class="text-muted">(+244) 999 000 222</div>
                        <div class="text-muted">(+244) 999 000 222</div>
                      </td>
                      <td data-label="Title" >
                        <div>Telecomunicações</div>
                        <div class="text-muted">NIF: 123456789</div>
                      </td>
                      <td class="text-muted" data-label="Role" >
                        ...
                        <div class="text-muted">
                            <div class="text-muted">No. de solicitações: 124</div>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                        <td data-label="Name" >
                          <div class="d-flex py-1 align-items-center">
                            <span class="avatar me-2" style="background-image: url({{ URL::to('dist/img/clients/multitel.jpeg') }})">
                            </span>
                            <div class="flex-fill">
                              <div class="font-weight-medium">Multitel</div>
                              <div class="text-muted"><a href="#" class="text-reset">multitel.co.ao</a></div>
                            </div>
                          </div>
                        </td>
                        <td data-label="Address" >
                          <div>Rua 543, Avenida C, Luanda, Angola</div>
                          <div class="text-muted"><a href="#" class="text-reset">geral@multitel.co.ao</a></div>
                        </td>
                        <td data-label="Contacts" >
                          <div class="text-muted">(+244) 999 000 222</div>
                          <div class="text-muted">(+244) 999 000 222</div>
                        ...
                        <td class="text-muted" data-label="Role" >
                          <div>
                              <span class="badge bg-primary me-1"></span> Lead
                          </div>
                          <div class="text-muted">
                              <div class="text-muted">No. de solicitações: 124</div>
                          </div>
